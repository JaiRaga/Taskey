...
import { Grid, Paper, makeStyles, ButtonBase, IconButton, Typography } from "@material-ui/core"
    ...
    return (
        ...
        //     <Grid item>
                <Paper elevation={11} className={classes.margin}>
                    <Grid container item>
                        <Grid item xs={8}>
                            <Typography align="center" className={classes.description}>{task.description}</Typography>
                            </Grid>
